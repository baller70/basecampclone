    ...
    <header className="bg-white border-b border-gray-200 w-full">
      <div className="max-w-7xl mx-auto flex items-center justify-between h-20">
        ...
        <div className="flex items-center whitespace-nowrap">
          <Image src="/basecamp-logo.svg" alt="Basecamp logo" width={32} height={32} className="mr-2" />
          <span className="flex items-center text-black text-lg">
            ...
            <Image src="/37signals-logo.svg" alt="37signals logo" width={24} height={24} className="mx-1" />
